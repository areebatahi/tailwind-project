            ...
            <div className="bg-gray-100 py-16">
                <div className="container mx-auto max-w-screen-xl px-4 flex flex-col lg:flex-row items-center justify-between gap-10">
                    ...
                    <div className="flex justify-center lg:justify-start">
                        <img src="/src/assets/img/footer-img.PNG" alt="Mobile App" className="w-[300px] sm:w-[400px] rounded-md" />
                    </div>
                    ...
                    <div className="text-center lg:text-left max-w-xl">
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                            <button className="flex items-center bg-[#02062e] text-white font-semibold px-4 py-2 rounded-md hover:bg-opacity-90">
                                <img src="/src/assets/img/app-store.png" className="w-6 h-6 mr-2" alt="App Store" />
                                Get it on the App Store
                            </button>
                            <button className="flex items-center bg-blue-500 text-white font-semibold px-4 py-2 rounded-md hover:bg-blue-600">
                                <img src="/src/assets/img/google-play.png" className="w-6 h-6 mr-2" alt="Google Play" />
            ...
            <footer className="bg-white border-t">
                <div className="container mx-auto max-w-screen-xl px-4 py-6 flex flex-col sm:flex-row items-center justify-between">
                    ...
                    <div className="flex space-x-4">
                        <img src="/src/assets/img/facebookLogo.png" alt="Facebook" className="w-6 h-6 cursor-pointer hover:scale-105 transition" />
                        <img src="/src/assets/img/linkedinLogo.png" alt="LinkedIn" className="w-6 h-6 cursor-pointer hover:scale-105 transition" />
                        <img src="/src/assets/img/twiterLogo.png" alt="Twitter" className="w-6 h-6 cursor-pointer hover:scale-105 transition" />
                    </div>
                </div>
            </footer>
        </>
