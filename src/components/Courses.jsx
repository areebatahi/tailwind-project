            ...
            <div className="container mx-auto max-w-screen-xl px-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                    ...
                    <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col">
                        <img src="/assets/img/GraphicDesigners.PNG" alt="Graphic Design" className="w-full h-48 object-cover" />
                    ...
                    {/* Course Card 2 */}
                    <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col">
                        <img src="/assets/img/WebDevelopment.PNG" alt="Web Development" className="w-full h-48 object-cover" />
                        <div className="p-6 flex flex-col justify-between flex-1">
                    ...
                    {/* Course Card 3 */}
                    <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col">
                        <img src="/assets/img/SEO.PNG" alt="SEO" className="w-full h-48 object-cover" />
                        <div className="p-6 flex flex-col justify-between flex-1">
